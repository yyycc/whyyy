  ...
  render() {
    ...
    return (
      <div className="blog-view-three">
        ...
        <h2 id="view-three-2">2. bootstrap栅栏系统css中的col-</h2>
        ...
        <h2 id="view-three-3">3. reflow和repaint</h2>
        ...
        <h2 id="view-three-4">4. html5语义化标签</h2>
        ...
        <h2 id="view-three-6">6. commonJS</h2>
        <h2 id="view-three-7">7. 变量提升</h2>
        <h2 id="view-three-8">8. bind、call、apply</h2>
        <h2 id="view-three-9">9. 如何实现一个左右固定，中间自适应的三栏布局</h2>
        <h2 id="view-three-10">10. Babel原理</h2>
