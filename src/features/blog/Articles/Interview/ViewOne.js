  ...
  render() {
    ...
    return (
      <div className="blog-view-one">
        ...
        <h3 id="view-one-5-2">5.2. 垂直居中</h3>
        ...
        <h3 id="view-one-8-1">8.1. 方法一</h3>
        <PreFormat content={codes[0]}/>
        <h3 id="view-one-8-2">8.2. 方法二</h3>
        <p>BFC(见/three)清除浮动</p>
        <p>创建父级 BFC(overflow:hidden)</p>
        <p>父级设置高度</p>
        <PreFormat content={bfc}/>
        <h3 id="view-one-8-3">8.3. 方法三</h3>
        <p>伪元素清除浮动：</p>
        <p>给父div添加after伪元素</p>
        <PreFormat content={after}/>
        <h3 id="view-one-8-4">8.4. 方法四</h3>
        <p>给父元素设置高度</p>

        <h2 id="view-one-9">9. 页面渲染html的过程</h2>
        <p>浏览器渲染页面的一般过程：</p>
        ...
        <h2 id="view-one-10">10. 事件代理</h2>
        <h3 id="view-one-10-1">10.1. 原理</h3>
        ...
        <h3 id="view-one-10-2">10.2. 优点</h3>
